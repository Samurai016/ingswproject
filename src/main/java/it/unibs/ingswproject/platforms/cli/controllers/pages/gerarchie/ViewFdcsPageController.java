...
public class ViewFdcsPageController  extends CliPageController {
    ...
    @PageConstructor
    public ViewFdcsPageController(CliApp app, Translator translator, AuthService authService, PageFactory pageFactory, CliUtils cliUtils, ProjectUtils projectUtils, StorageService storageService, ErrorManager errorHandler, RoutingComputationStrategy routingComputationStrategy) {
        super(app, translator);
        this.authService = authService;
        this.pageFactory = pageFactory;
        this.view = new ViewFdcsPageView(app, this, translator, cliUtils, projectUtils, storageService, errorHandler, authService, routingComputationStrategy);
    }
