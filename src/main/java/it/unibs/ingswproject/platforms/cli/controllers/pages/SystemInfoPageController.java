...
public class SystemInfoPageController extends CliPageController {
    @PageConstructor
    public SystemInfoPageController(CliApp app, Translator translator, AuthService authService, CliUtils cliUtils, ProjectUtils projectUtils, StorageService storageService) {
