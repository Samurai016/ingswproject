...
public class AddPropostaDiScambioPageController extends CliPageController {
    ...
    @PageConstructor
    public AddPropostaDiScambioPageController(CliApp app, Translator translator, AuthService authService, PageFactory pageFactory, StorageService storageService, ErrorManager errorManager, CliUtils cliUtils, ProjectUtils projectUtils, RoutingComputationStrategy routingComputationStrategy) {
        super(app, translator);
        this.authService = authService;
        this.pageFactory = pageFactory;
        TreeRenderer treeRenderer = new OneLevelTreeRenderer(this.translator);
        this.view = new AddPropostaDiScambioPageView(app, this, translator, storageService, errorManager, cliUtils, projectUtils, authService, routingComputationStrategy, treeRenderer);
