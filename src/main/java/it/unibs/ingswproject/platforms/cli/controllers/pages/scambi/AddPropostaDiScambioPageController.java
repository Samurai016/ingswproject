...
public class AddPropostaDiScambioPageController extends CliPageController {
    ...
    @PageConstructor
    public AddPropostaDiScambioPageController(CliApp app, Translator translator, AuthService authService, PageFactory pageFactory, StorageService storageService, ErrorManager errorManager, CliUtils cliUtils, ProjectUtils projectUtils, RoutingComputationStrategy routingComputationStrategy, ScambioStrategy scambioStrategy) {
